...
use Generator;
use Simtabi\Pheg\Toolbox\File\Contracts\FileInterface;
use Simtabi\Pheg\Toolbox\File\Exception\CursorException;
use Simtabi\Pheg\Toolbox\File\Exception\LockException;
use Simtabi\Pheg\Toolbox\File\Exception\ReadException;
use Simtabi\Pheg\Toolbox\File\Exception\ResourceException;
use Simtabi\Pheg\Toolbox\File\Exception\WriteException;
 ...
 */
class FileStream implements FileInterface
{
    /**
     * The file stream.
     *
    ...
    private function readBytes($bytes)
    {
        ...
        if (($read = strlen($buffer)) !== $bytes) {
            throw new ReadException(
                sprintf('Only %d of %d bytes could be read from the file stream.', $read, $bytes)
            );
        }
