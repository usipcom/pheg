...
namespace Simtabi\Pheg\Toolbox\Arrays;
...
final class Arr
{
    ...
    public function toStdObject(array $array): object
    {
    ...
    public function toArray($object, bool $assoc = true)
    {
