...
abstract class BaseFactory
{
    ...
    /**
     * @param BaseFactory $color
     * @param int                          $percent
     *
     * @return mixed
     */
    public function mix(BaseFactory $color, $percent = 50)
    {
        $first  = $this->toRgb();
        $second = $color->toRgb();
        $weight = $percent / 100;
     ...
     * @param BaseFactory $color
     *
     * @return $this|Hex|Hsl|Hsv|Rgb
     */
    protected function back(BaseFactory $color)
    {
     ...
     * @return false|string
     */
    protected function getColorModelName(BaseFactory $color)
    {
